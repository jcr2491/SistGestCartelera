<%@ Page Language="C#" EnableEventValidation="false" MasterPageFile="~/Principal.master" AutoEventWireup="true" CodeFile="ParPromociones.aspx.cs" Inherits="ParPromociones" Title="Página sin título" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div align="center" 
        style="background-color: #FF6600; color: #FFFFFF; font-weight: bold; font-size: medium;">			    
	    Mantenimiento de Promociones
    </div>
    
    <br />
    
    <ajax:UpdatePanel ID="upnlParPromociones" runat="server">
        ...
        <ContentTemplate>            
                ...
                <table cellspacing="0" cellpadding = "0" rules="all" border="1" id="tblHeader" 
                 ...
                 border-collapse:collapse;height:100%;">
                    <tr>
                       ...
                       <td style ="width:300px;text-align:center">Promoción</td>
                    </tr>
                </table>
            ...
            <div align="center" class="DivGridview" style="height:200px;">
                ...
                <asp:GridView ID="grvPromocion" runat="server" AutoGenerateColumns="False" 
                    CssClass="Grid" DataKeyNames="ID_PROMOCION" ShowHeader="false"
                    onrowdatabound="grvPromocion_RowDataBound">
                    ...
                    <Columns>                        
                        ...
                        <asp:BoundField DataField="ID_PROMOCION" HeaderText="Id"  ReadOnly="true"  >
                        ...
                        <asp:BoundField DataField="NOM_PROMOCION" HeaderText="Promoción"  ReadOnly="true" >
            ...
            <asp:Panel ID="pnlDetalle" runat="server" Style="visibility:hidden;">
                ...
                <div id="Detalle" class="DivBorder" align="center">
                    ...
                    <div class="DivBoxDetPromociones">
